...
// ** Juan Manuel Rubio Rodriguez 2018
// **
...
// ** ply::tipo_fichero
// **
// ** lee la cabecera del archivo ply y devuelve un 0 o un 1 en funcion de si tiene caras o no
// **
// **   - 'nombre_archivo' nombre del archivo (se le añade .ply si no acaba en .ply
// **
// **   - devuelve un 0 en caso de ser un archivo ply sin indice de caras declarado
// **   - devuelve un 1 en caso de ser un archivo ply con indice de caras declarado
// **
// **
// **********************************************************************

int tipo_fichero (const std::string & nombre_archivo);
